  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto p-8 my-14 flex justify-center flex-wrap gap-14">
        <div className="py-8 px-10  ring-1 rounded-3xl text-center max-w-[420px] flex flex-col justify-between items-center shadow-xl">
          <h1 className="text-4xl opacity-80">
            How internship will Benifit you?
          </h1>
          <p className="text-md opacity-60">
            Gain hands-on experience at Easypaper to build upon skills learned
            in the classroom and to establish a clear connection between
            education and work.
          </p>
        </div>
        <div className="py-8 px-10  ring-1 rounded-3xl text-center max-w-[420px] flex flex-col justify-between items-center gap-8">
          <h1 className="text-4xl opacity-80">
            Why do we Provide Internships?
          </h1>
          <p className="text-md opacity-60">
