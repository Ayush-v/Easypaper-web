...
const HeroSection = () => {
  return (
    <>
      <div className="mb-16 max-w-screen-xl mx-auto px-10 sm:pb-8 lg:pb-0 sm:pt-24 py-14 bg-gradient-to-br from-[#3675F0] to-[#2651A6] clipping rounded-b-3xl text-white flex flex-col relative overflow-hidden md:flex-row gap-9">
